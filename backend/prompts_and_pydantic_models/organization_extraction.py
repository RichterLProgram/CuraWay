...
- facilities: A publishable healthcare facility is any physical site that is currently operating and delivers in-person medical diagnosis or treatment to patients. This includes hospitals, clinics, health centers, specialty practices, and medical centers. Administrative offices, research-only centers, supply storage sites, long-term custodial homes, virtual-only services, and other non-clinical sites do not qualify.
