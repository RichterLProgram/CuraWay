"""
Unit tests for idp (extraction_agent, schemas) and decision (capability_decision).
"""
import json
import pytest
...
from features.idp.schemas import (
    FacilityInfo,
    Capabilities,
    Metadata,
    CapabilitySchema,
...
class TestIDPAgent:
    ...
    def test_detect_suspicious_claims(self):
        ...
        claims = detect_suspicious_claims("We offer world-class care. State-of-the-art equipment.")
        assert len(claims) >= 2
