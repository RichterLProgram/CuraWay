# Test-Erkenntnisse: backend/idp_agent.py

**Datum:** 7. Februar 2025  
**Getestet:** `idp_agent.py` – IDP-Agent für Extraktion von Klinik-Kapazitäten aus unstrukturiertem Text
...
**Pfad:** `backend/test/test_idp_agent.py`  
**Lauf:** `cd backend && python -m pytest test/test_idp_agent.py -v`
